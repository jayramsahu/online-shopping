...
$qr="select * from customer_orders where customer_id='$c_id' AND order_status='pending'";

$run_order=mysqli_query($db,$qr);
...
if($count>0)
{
	echo "<div style='pedding :10px;'>
	<h1 style='color:red'>Importent</h1>
	<h2>You have $count pending order</h2>
	<h3>Please see your order details by clicking this<a href='my_account.php?my_order'>LINK</h3></div>
	...
	echo "<div style='pedding :10px;'>
	<h1 style='color:red'>Importent</h1>
	<h2>You have NO pending order</h2>
	<h3>You can see Your order histry  by clicking this<a href='my_account.php?my_order'>LINK</h3></div>
